...
begin
  ...
  ShellExecute(handle,'open','mailto:Micha Nelissen <micha@neli.hopto.org>',
...
begin
  // Nice and easy isn't it ?
  ShellExecute(handle,'open','http://tdbf.sf.net',nil,nil,SW_SHOWNORMAL);
end;
